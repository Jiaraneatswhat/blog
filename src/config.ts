...
export const siteConfig: SiteConfig = {
	title: "AcePerhydrophenanthrene",
	subtitle: "",
	siteURL: "https://www.taffybook.cn/", // 请替换为你的站点URL，以斜杠结尾
	...
	bilibili: {
		vmid: "22876427", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		src: {
			desktop: [
				...
				"/assets/desktop-banner/pc3.png",
				"/assets/desktop-banner/pc4.png",
			], // 桌面横幅图片
			mobile: [
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/taffy.webp", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "永雏多氢菲",
	bio: "∴さて····どこへ行こうか？",
	typewriter: {
...
export const commentConfig: CommentConfig = {
	...
	giscus: {
		repo: "Jiaraneatswhat/blog_comment",
		repoId: "R_kgDOSLObMQ",
		category: "Announcements",
		categoryId: "DIC_kwDOSLObMc4C7lS4",
		mapping: "pathname",
		strict: "0",
		reactionsEnabled: "1",
		emitMetadata: "0",
...
export const footerConfig: FooterConfig = {
	...
	customHtml: "ようこそ<ruby>書庫<rt>ミーミルノヰツヅミ</ruby>・デ・永雏多氢菲へ", // HTML格式的自定义页脚信息，例如备案号等，默认留空
